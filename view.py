...
my_data = my_data[:, [0, 39, 52, 65, 78, 91, 104, 117, 130, 143, 13, 26,
                      1, 40, 53, 66, 79, 92, 105, 118, 131, 144, 14, 27,
                      5, 44, 57, 70, 83, 96, 109, 122, 135, 148, 18, 31,
                      6, 45, 58, 71, 84, 97, 110, 123, 136, 149, 19, 32,
                      7, 46, 59, 72, 85, 98, 111, 124, 137, 150, 20, 33,
                      8, 47, 60, 73, 86, 99, 112, 125, 138, 151, 21, 34,
                      9, 48, 61, 74, 87, 100, 113, 126, 139, 152, 22, 35,
                      10, 49, 62, 75, 88, 101, 114, 127, 140, 153, 23, 36,
                      11, 50, 63, 76, 89, 102, 115, 128, 141, 154, 24, 37,
                      12, 51, 64, 77, 90, 103, 116, 129, 142, 155, 25, 38,
                      2, 41, 54, 67, 80, 93, 106, 119, 132, 145, 15, 28,
                      3, 42, 55, 68, 81, 94, 107, 120, 133, 146, 16, 29,
                      4, 43, 56, 69, 82, 95, 108, 121, 134, 147, 17, 30]]

flammea_1 = np.empty((12, 13), int)
...
flammea_1 = np.delete(flammea_1, slice(0, 13), axis=0)

palustris_1 = np.empty((12, 13), int)
...
palustris_1 = np.delete(palustris_1, slice(0, 13), axis=0)
